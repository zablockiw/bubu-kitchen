package app.zablocki.bubukitchen.repository;

import app.zablocki.bubukitchen.BubuKitchenApp;
import app.zablocki.bubukitchen.config.Constants;
import app.zablocki.bubukitchen.config.audit.AuditEventConverter;
import app.zablocki.bubukitchen.domain.PersistentAuditEvent;
...
import static app.zablocki.bubukitchen.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
